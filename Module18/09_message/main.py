...
# TODO: Лишний код. Удобно должно быть не автору кода, а тому кто потом будет его поддерживать;)
...
# TODO: На данный момент код не читабельный.
#  Чтобы понять что он делает нужно вчитываться и анализировать.
#  Если код будет декомпозирован на ф-ии и ф-ии будут информативно названы, то достаточно будет посмотреть на алгоритм,
#  в котором эти ф-ии вызываются и сразу станет понятно что происходит в программе:)
