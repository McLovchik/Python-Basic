...
# в функцию
# TODO: А в чем собственно проблема?:)
#  Несколько аргументов - это нормально. А вот нечитабельный код, увы, нет:(
#  Попробуйте содержимое elif декомпозировать в ф-ию с информативным именем;)
